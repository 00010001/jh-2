...
public class ClientResource {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(
                existingClient -> {
                    if (client.getWlascicielDomu() != null) {
                        existingClient.setWlascicielDomu(client.getWlascicielDomu());
                    }
                    if (client.getNumer() != null) {
                        existingClient.setNumer(client.getNumer());
                    }
                    if (client.getAdres() != null) {
                        existingClient.setAdres(client.getAdres());
                    }
